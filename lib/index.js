...
function getProxies() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, html, $, proxies;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    puppeteer_extra_1.default;
                    return [4 /*yield*/, puppeteer_extra_1.default.launch({ headless: 'new' })];
                case 1:
                    browser = _a.sent();
                    return [4 /*yield*/, browser.newPage()];
                case 2:
                    page = _a.sent();
                    return [4 /*yield*/, page.goto('https://spys.one/free-proxy-list', {
                ...
                case 4:
                    ...
                    $('table table table:nth-child(2) > tbody tr').each(function () {
                        ...
                        var type = $(this).find('td:nth-child(2)').text().trim().split(' ')[0];
                        ...
                        if (host && port && type && status === 'OK' && country) {
                            proxies.push({ host: host, port: Number(port), type: type, country: country });
                        }
                    });
